...
export CENTRIFYCC_NETWORK_ADDR_TYPE=PrivateIP
...
export CENTRIFYDC_REDHAT_TOKEN='lWX3bAmjyUQIjbVM'
...
export CENTRIFYDC_ZONE_NAME=CNMC
...
export CENTRIFYDC_KEYTAB_S3_BUCKET=awscentrifytest
...
TEMP_DEPLOY_DIR=/opt/auto_centrify_deployment
